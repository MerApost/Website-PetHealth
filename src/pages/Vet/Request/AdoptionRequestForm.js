      ...
      <div className="lr-section">
        ...
        <Box className="lr-grid">
          <TextField
            ...
            error={Boolean(errors.adopterFirstName)}
            helperText={errors.adopterFirstName || ""}
          />
          <TextField
            size="small"
            ...
            error={Boolean(errors.adopterAddress)}
            helperText={errors.adopterAddress || ""}
          />
          <TextField
            size="small"
            label="Επώνυμο: *"
            ...
            error={Boolean(errors.adopterLastName)}
            helperText={errors.adopterLastName || ""}
          />
          <TextField
            size="small"
            type="email"
            ...
            helperText={errors.adopterEmail || ""}
          />
          <TextField
            size="small"
            label="Τηλέφωνο: *"
