...
export default function FosterRequestPreview({ form }) {
  return (
    <Paper elevation={0} className="lr-card">
      ...
      <div className="lr-section">
        ...
        <Box className="lr-grid">
          <TextField size="small" label="Όνομα: *" value={form.fosterFirstName} disabled />
          <TextField size="small" label="Διεύθυνση Κατοικίας: *" value={form.fosterAddress} disabled />
          <TextField size="small" label="Επώνυμο: *" value={form.fosterLastName} disabled />
          <TextField size="small" label="E-mail: *" value={form.fosterEmail} disabled />
          <TextField size="small" label="Τηλέφωνο: *" value={form.fosterPhone} disabled />
        </Box>
      </div>
